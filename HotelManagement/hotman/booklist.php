...
<HTML>
    ...
    <head>
        ...
        <title>TourisMY Hotel - Booking List</title>
 ...
 <body>
  ...
  <div id="taskbar">
            ...
            <a href="viewbooking.html">Booking List</a>
            </span>
            <span class="viewstaff">
            <a href="stafflist.php">Staff Detail</a>
            </span>
            <span class="viewpackage">
            <a href="package.php">Hotel Packages</a>
            </span>
            <span class="viewroom">
            <a href="room.php">Room List</a>
            </span>
        </div>
...
<?php
    ...
    while($row=mysqli_fetch_array($retval)){
        ...
        echo "<td><a href=user_update.php?id=".$row['UserID'].">Update</a>  <a href=user_delete.php?id=".$row['UserID'].">Delete</a></td>";
        echo "</tr>";
        echo "</tbody>";
    }
