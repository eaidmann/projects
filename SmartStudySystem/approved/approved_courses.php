...
$query = "Select courseID, courseName, courseDesc, courseMentor, ApprovBy from course where ApprovBy='$idnumber'";
...
<html>
    <head>
    <title>View Approved Courses </title>
...
<body id="allcourses">
    <ul>
		...
		<li><a class="active" href="approved_courses.php">My Approval</a></li>
        <li><a href="../account/myaccount_lecturer.php">My Account</a></li>
        <li class="logoutbtn"><a href="../logout/logout2.php">Logout</a></li>
    </ul>
    
    <div class="Title">
            <h1>APPROVED COURSES DETAILS </h1>
            <p1>In this page, display all courses details that the lecturer ownself had approved. Lecturer can view the record and drop the courses which had break the teaching policy.  </p1>
    </div>
    ...
    <table align="center" style="width: 75%"> 
		...
		echo "<td><p align='center'><a href=drop_course.php?id=" .$row['courseID']. " /><input type='button' name='dropcourse' value='Drop' /></a></td>";
